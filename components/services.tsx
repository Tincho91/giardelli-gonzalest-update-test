  ...
  const items = [
    {
      ...
      content: (
        <p className="text-white text-center font-normal text-md lg:text-xl md:leading-[35px] px-10 mb-5 z-40">
          ...
          <span className="text-white font-black text-xl lg:text-2xl"> La ventaja de transitar este camino es descubrir y construir EL MEJOR SISTEMA posible para alcanzar las metas de la organización. </span>
        </p>
      )
    },
    {
    ...
    },
    {
      ...
      content: (
        <p className="text-white text-center font-normal text-md lg:text-xl md:leading-[35px] px-10 mb-5 z-40">
          ...
          <br /><br />
          <span className="text-white font-bold text-xl lg:text-2xl"> Propiciamos el camino para que cada uno sea la mejor versión de sí. </span>
        </p>
      )
    },
    {
      ...
      content: (
        <p className="text-white text-center font-normal text-md lg:text-xl md:leading-[35px] px-10 mb-5 z-40">
          ...
          <br /><br />
          <span className="text-white font-bold text-xl lg:text-2xl"> Armar la estructura y definir las funciones del área de recursos humanos, constituye una prioridad para las empresas de hoy.</span>
        </p>
      )
    },
    {
      ...
      content: (
        <p className="text-white text-center font-normal text-md lg:text-xl md:leading-[35px] px-10 mb-5 z-40">
          ...
          <br /><br />
          <span className="text-white font-bold text-xl lg:text-2xl"> Buscamos  nuevos líderes capaces de consolidar y guiar a los equipos de trabajo de manera tal de aumentar la productividad y garantizar buenas relaciones interpersonales. </span>
        </p>
      )
    },
    {
      ...
      content: (
        <p className="text-white text-center font-normal text-md lg:text-xl md:leading-[35px] px-10 mb-5 z-40">
          ...
          <br /><br />
          <span className="text-white font-bold text-xl lg:text-2xl"> Tener talentos en nuestra organización nos acerca a ser mejores, pero si a eso le sumamos el valor del aprendizaje continuo, nos transformamos en especiales. </span>
        </p>
      )
    },
    {
      ...
      content: (
        <p className="text-white text-center font-normal text-md lg:text-xl md:leading-[35px] px-10 mb-5 z-40">
          ...
          <br /><br />
          <span className="text-white font-bold text-xl lg:text-2xl"> Los sistemas comerciales son mucho más que definir qué comprar, qué producir y qué vender.</span>
        </p>
      )
    }
  ];
